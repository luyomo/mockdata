...
* Install
  #+BEGIN_SRC
OhMyTiUP$ wget https://github.com/luyomo/mockdata/releases/download/v0.0.3/mockdata_0.0.3_linux_amd64.tar.gz
OhMyTiUP$ tar xvf mockdata_0.0.3_linux_amd64.tar.gz
